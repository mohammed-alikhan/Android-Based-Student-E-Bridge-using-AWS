...
public class S3 {
	...
	String aa="/AndroidAmazon/Ebridge/";
	static {
	...
	public static AmazonS3 getInstance() {
        if ( s3 == null ) {
		    s3 = new AmazonS3Client( new BasicAWSCredentials(Constants.ACCESS_KEY_ID,Constants.SECRET_KEY));
        }
...
public static void createFolder2( String folderName ) {
	...
	public static InputStream getDataForObject( String bucketName, String objectName ) {
		Log.e("SIvaaaaaaaaaaaaaaaa", ""+getInstance().getObject( bucketName, objectName ).getObjectContent());
